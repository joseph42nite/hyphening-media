...
export function buildContentPayload(formData) {
  return {
    ...
    skip_rate_pct: formData.skip_rate_pct !== '' ? parseFloat(formData.skip_rate_pct) : null,
...
export function buildContentFormState(content) {
  ...
  return {
    ...
    skip_rate_pct: content.skip_rate_pct !== null && content.skip_rate_pct !== undefined ? String(content.skip_rate_pct) : '',
