...
export function KageLandingPage(props: LandingPageProps & PageTypographyProps) {
  ...
  return <LandingPageFrame {...frame} customization={customization} title="Hyphening Media — Where craft scales into performance" sourceUrl="/landing-pages/kage.html?v=ing-media-16" />;
}
